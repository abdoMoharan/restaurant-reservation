...
class ReservationController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.reservations.edit', compact('tables', 'reservations'));
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ReservationStoreRequest $request)
    {
    ...
    public function destroy(Request $request)
    {
        ...
        return to_route('admin.reservations.index')->with('danger', 'reservation is delete successfully.');
    }
}
